...
if (isset($_POST['save']) && wp_verify_nonce($_POST['nonce'], 'edit')) {
    $title = $_POST['title'];
    $code = $_POST['code'];
...
if (isset($_REQUEST['id']) && ctype_digit($_REQUEST['id'])) {
    $row = $wpdb->get_row($wpdb->prepare("SELECT * FROM " . $table_name . " WHERE id = %d", $_REQUEST['id']));
}
?>
        ...
        <div class="Polaris-Page-Header">
            <div class="Polaris-Page-Header__MainContent">
                    ...
                    <div>
                        <div class="Polaris-Header-Title__TitleAndSubtitleWrapper">
                            <div class="Polaris-Header-Title"><h1
                                        class="Polaris-DisplayText Polaris-DisplayText--sizeLarge">Edit Widget</h1>
                ...
                <div class="Polaris-Page-Header__PrimaryActionWrapper"><a
                            href="<?php echo site_url(); ?>/wp-admin/admin.php?page=art-placer"
                            class="Polaris-Button Cancle"><span class="Polaris-Button__Content"><span
                                    class="Polaris-Button__Text">Cancel</span></span></a></div>
            </div>
        </div>
                        ...
                        <div class="Polaris-FormLayout">
                            <div class="Polaris-FormLayout__Item">
                                <div class="firstsection" style="display: none;">
                                    <div class="Polaris-TextContainer"><h2 class="Polaris-Heading">Let's Edit widget for
                                            your site.</h2>
                                        <p class="firstheading">Click on the button below to get started.</p></div>
                            ...
                            <div class="Polaris-FormLayout__Item secondsection" style="">
                                <div class="Polaris-Labelled__LabelWrapper">
                                    <div class="Polaris-Label"><label id="PolarisTextField9Label"
                                                                      for="PolarisTextField9"
                                                                      class="Polaris-Label__Text">Name</label></div>
                                </div>
                                <div class="Polaris-Connected">
                                    <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                        <div class="Polaris-TextField"><input id="PolarisTextField9" type="text"
                                                                              aria-labelledby="PolarisTextField8Label"
                                                                              name="title" aria-invalid="false"
                                ...
                                <div class="Polaris-Labelled__LabelWrapper">
                                    <div class="Polaris-Label"><label id="PolarisTextField4Label"
                                    ...
                                    <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                        <div class="Polaris-TextField Polaris-TextField--hasValue Polaris-TextField--multiline">
                                            <textarea name="code" id="PolarisTextField4"
                                                      ...
                                                      class="Polaris-TextField__Input"
                                                      style="height: 108px;"><?php echo htmlspecialchars($row->code); ?></textarea>&gt;
                                            <div class="Polaris-TextField__Backdrop"></div>
                                ...
                                ?>
                                    <div class="Polaris-Labelled__LabelWrapper">
                                        <div class="Polaris-Label">
                                            <label id="PolarisSelect3Label" for="PolarisSelect3" class="Polaris-Label__Text">Widget Position</label>
                                        </div>
                                    </div>
                                    <div class="Polaris-Select"><select id="PolarisSelect3" aria-invalid="false"
                                                                        class="Polaris-Select__Input" name="position">
                                            <option value="Above Description" <?php if ($row->position == "Above Description") {
                                                echo 'selected';
                                            } ?> >Above Description
                                            </option>
                                            <option value="Below Description" <?php if ($row->position == "Below Description") {
                                                echo 'selected';
                                            } ?> >Below Description
                                            </option>
                                            <option value="Below Add to cart" <?php if ($row->position == "Below Add to cart") {
                                                echo 'selected';
                                            } ?> >Below Add to cart
                                            </option>
                                            <option value="Floating Sidebar" <?php if ($row->position == "Floating Sidebar") {
                                                echo 'selected';
                                            } ?> >Floating
                                            </option>
                                        </select>
                                        <div aria-hidden="true" class="Polaris-Select__Content"><span
                                                    class="Polaris-Select__SelectedOption selectposition"><?php echo $row->position; ?></span><span
                                                    ...
                                                    <li tabindex="-1" class="Polaris-OptionList-Option"><label
                                                            ...
                                                            <div class="Polaris-OptionList-Option__Checkbox">
                                                                <div class="Polaris-OptionList-Checkbox">
                                                                    <input <?php if (in_array($category->term_id, $cats)) {
                                                                        echo 'checked';
                                                                    } ?> name="categories[]"
                                                                         id="<?= $category->term_id; ?>" type="checkbox"
                                                                         aria-checked=""
